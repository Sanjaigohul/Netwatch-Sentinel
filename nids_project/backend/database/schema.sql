...
ALTER TABLE packets ADD COLUMN protocol_num TINYINT UNSIGNED DEFAULT 0;
ALTER TABLE packets ADD COLUMN ttl         TINYINT UNSIGNED DEFAULT 0;
...
ALTER TABLE results ADD COLUMN timestamp   DATETIME(3)  NOT NULL DEFAULT CURRENT_TIMESTAMP(3);
ALTER TABLE results ADD COLUMN src_ip      VARCHAR(45)  NOT NULL;
ALTER TABLE results ADD COLUMN dst_ip      VARCHAR(45)  NOT NULL;
ALTER TABLE results ADD COLUMN protocol    VARCHAR(10)  DEFAULT 'UNKNOWN';
ALTER TABLE results ADD COLUMN is_blacklisted TINYINT(1) DEFAULT 0;
...
ALTER TABLE features ADD COLUMN feature_vector JSON NOT NULL;

ALTER TABLE alerts ADD COLUMN timestamp    DATETIME(3)  NOT NULL DEFAULT CURRENT_TIMESTAMP(3);
ALTER TABLE alerts ADD COLUMN src_ip       VARCHAR(45)  NOT NULL;
ALTER TABLE alerts ADD COLUMN dst_ip       VARCHAR(45)  NOT NULL;
ALTER TABLE alerts ADD COLUMN attack_type  VARCHAR(50)  DEFAULT 'Unknown';
ALTER TABLE alerts ADD COLUMN threat_level ENUM('Low','Medium','High','Critical') DEFAULT 'High';
ALTER TABLE alerts ADD COLUMN anomaly_score FLOAT       DEFAULT 0.0;
ALTER TABLE alerts ADD COLUMN acknowledged TINYINT(1)   DEFAULT 0;

ALTER TABLE anomaly_alerts ADD COLUMN timestamp    DATETIME(3)  NOT NULL DEFAULT CURRENT_TIMESTAMP(3);
ALTER TABLE anomaly_alerts ADD COLUMN src_ip       VARCHAR(45)  NOT NULL;
ALTER TABLE anomaly_alerts ADD COLUMN dst_ip       VARCHAR(45)  NOT NULL;
ALTER TABLE anomaly_alerts ADD COLUMN attack_type  VARCHAR(50)  DEFAULT 'Unknown';
ALTER TABLE anomaly_alerts ADD COLUMN threat_level ENUM('Low','Medium','High','Critical') DEFAULT 'High';
ALTER TABLE anomaly_alerts ADD COLUMN anomaly_score FLOAT       DEFAULT 0.0;
ALTER TABLE anomaly_alerts ADD COLUMN acknowledged TINYINT(1)   DEFAULT 0;
